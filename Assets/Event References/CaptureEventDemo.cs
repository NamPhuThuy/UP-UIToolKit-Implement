...
public class CaptureEventDemo : MonoBehaviour
{
    ...
    void RegisterMoveBoxEvents()
    {
        moveBox.RegisterCallback<PointerDownEvent>(evt =>
        {
            ...
            moveBox.CapturePointer(evt.pointerId);
        });
        ...
        {
            isDragging = false;
            moveBox.ReleasePointer(evt.pointerId);
        });

        moveBox.RegisterCallback<PointerCaptureEvent>(evt =>
        {
            moveBox.style.backgroundColor = Color.white;
        });
        
        moveBox.RegisterCallback<PointerCaptureOutEvent>(evt =>
        {
            moveBox.style.backgroundColor = Color.red;
        });
    }
